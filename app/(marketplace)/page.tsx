...
// This is the page component for the home page
                ...
                <div className="container">
                    ...
                    {products && products.length > 0 ? (
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                            ...
                            {/* using "map" function to iterate over the "products" array */}
                            {products.map((product) => (

                                // introduce "ProductCard" component
                                <ProductCard
                                    key={product.id}
                                    product={product}
                                />
            ...
            <section className="py-16 bg-muted/50">
                <div className="container text-center">
                    ...
                    <p className="text-muted-foreground max-w-xl mx-auto mb-8">
                        Join our community of sellers and reach thousands of customers. No monthly fees, only pay when
                        you make a sale.
                    </p>
