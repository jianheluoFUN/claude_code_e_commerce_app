...
export interface Order {
    ...
    // within one order, there will be multiple order items
    items?: OrderItem[]
}
...
// This is the interface for the record in the "reviews"
export interface Review {
    id: string
    product_id: string

    // foreign key to record in the "profiles" table
    buyer_id: string

    // foreign key to record in the "orders" table
    order_id: string
